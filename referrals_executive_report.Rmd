...
reactable(
    ...
    columns = list(
      urgent = colDef(
        ...
        minWidth = 300,
        headerStyle = list(background = "#7f7f7f", color = "white", fontWeight = "Bold", fontSize = "22px"),
        style = list(fontWeight = "Bold", background = "#7f7f7f", color = "white"),
        align = "center"
        # footer = "*Excludes MSDD and NETWORK"
        ),
      blank_1 = colDef(
