  ...
  reactable(
    ...
    columns = list(
      `Internal Demand` = colDef(
        ...
        maxWidth = 250,
        headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "12px"),
      ...
      `External Demand` = colDef(
        name = "Top 15 Specialties",
        maxWidth = 250,
       headerStyle = list(background = "#00aeef", color = "white", fontWeight = "Bold", fontSize = "12px"),
        style = list(fontWeight = "Bold"),
        align = "left"
        # footer = "*Excludes MSDD and NETWORK"
        ),
