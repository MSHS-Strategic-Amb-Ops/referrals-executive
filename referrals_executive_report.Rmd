...
wq_volume_data <- wq_history_merged %>%
  ...
  mutate(wq_entered = format(as.Date(wq_entered, "%Y-%m-%d %HH:%MM:%SS"),"%Y-%m-%d"),
...
```{r Graph and Table Functions, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r Referrals YTD Snapshot Output, echo = FALSE, warning = FALSE, message = FALSE,  results='hide'}
