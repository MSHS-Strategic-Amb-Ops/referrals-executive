...
### Scheduling Priority
<span style='font-size: 16px; font-weight: bold; color: black'>**ED Referrals by Scheduling Priority**</span><br/>
...
ed_conversion_rate_graph <- 
  ...
  hc_legend(align = "left", verticalAlign = "top", itemStyle = list(fontFamily ='Calibri',color ='black', fontSize = "14px")) %>%
  hc_title(text = "ED vs. Non-ED Conversion Rate", align = "left", style = list(fontWeight = 'bold', fontSize = "22px", fontFamily = "Calibri")) %>%
  hc_subtitle(text = paste0("Based on referrals created from ","2022-04-01"," to ",report_run_date),
              align = "left", style = list(fontFace = "italic", fontSize = "16px", fontFamily = "Calibri")) %>%
  hc_tooltip(shared = TRUE, borderColor = "black")
...
ed_completion_rate_graph <- 
  ...
  hc_xAxis(title = "Referral Scheduling Priority") %>%
  hc_legend(align = "left", verticalAlign = "top", itemStyle = list(fontFamily ='Calibri',color ='black', fontSize = "14px")) %>%
  hc_title(text = "ED vs. Non-ED Completion Rate", align = "left", style = list(fontWeight = 'bold', fontSize = "22px", fontFamily = "Calibri")) %>%
  hc_subtitle(text = paste0("Based on referrals created from ","2022-04-01"," to ",report_run_date),
              align = "left", style = list(fontFace = "italic", fontSize = "16px", fontFamily = "Calibri")) %>%
  hc_tooltip(shared = TRUE, borderColor = "black")
...
### Sent To Specialty
<span style='font-size: 16px; font-weight: bold; color: black'>**ED Referrals by Original vs. Final Sent To Specialty**</span><br/>
<span style='font-size: 12px; font-weight: bold; color: black'>*Based on Referrals Created from 2022-04-01 to `r report_run_date``*</span><br/>
...
<span style='font-size: 16px; font-weight: bold; color: black'>**ED Referrals by Primary Diagnosis and Sent To Specialty**</span><br/>
<span style='font-size: 12px; font-weight: bold; color: black'>*Based on Referrals Created from 2022-04-01 to `r report_run_date``*</span><br/>
