...
*Data Source: EPIC Caboodle Referrals, ReferralFact, VisitFact, ReferralWorkqueueEventFactX, and ReferralWQReason * <br/>
...
### Scheduling Priority
<span style='font-size: 122px; font-weight: bold; color: black'>**ED Referrals by Scheduling Priority**</span><br/>
...
<span style='font-size: 16px; font-weight: bold; color: black'>**% of ED Referrals by Scheduling Priority**</span><br/>
<span style='font-size: 18px; font-weight: bold; color: black'>*Based on Referrals Created from 2022-04-01 to `r report_run_date`*</span><br/>
...
<span style='font-size: 16px; font-weight: bold; color: black'>**ED vs. Non-ED Conversion Rate by Month**</span><br/>
<span style='font-size: 12px; font-weight: bold; color: black'>*Based on Referrals Created from 2022-04-01 to `r report_run_date``*</span><br/>
...
<span style='font-size: 16px; font-weight: bold; color: black'>**ED vs. Non-ED Completion Rate by Month**</span><br/>
<span style='font-size: 12px; font-weight: bold; color: black'>*Based on Referrals Created from 2022-04-01 to `r report_run_date``*</span><br/>
...
reactable(
  ...
  columns = list(
    ICD_10_Chosen = colDef(name = "ICD 10 Chosen for Referral",
                           style = list(fontWeight = "Bold"),
                           minWidth = 250),
