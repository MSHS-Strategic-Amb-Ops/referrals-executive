...
```{r Referrals YTD Snapshot Output 1, echo = FALSE, warning = FALSE, message = FALSE, fig.width=12}
...
```{r Referrals YTD Snapshot Output 2, echo = FALSE, warning = FALSE, message = FALSE, fig.width=12}
...
reactable(
    ...
    columns = list(
      ...
      onTime = colDef(
        name = "% Referrals Scheduled On-Time Based on Scheduling Priority",
        minWidth = 300,
        headerStyle = list(background = "#00aeef", color = "white", fontWeight = "Bold", fontSize = "22px"),
        style = list(fontWeight = "Bold", background = "#00aeef", color = "white"),
        align = "center"
